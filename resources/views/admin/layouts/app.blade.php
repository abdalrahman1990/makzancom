...
<html lang="ar" dir="rtl" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
 ...
 --}}
    ...
    <link href="{{asset('assets/admin/css/custom-rtl.min.css')}}" rel="stylesheet" type="text/css" />
    ...
    <div id="layout-wrapper">
        ...
        <div class="layout-width">
          <div class="navbar-header">
            <div class="d-flex">
              ...
              <div class="navbar-brand-box horizontal-logo" style='margin-top:15px !important'>
            
                <a href="index.html" class="logo logo-dark">
                  <span class="logo-sm"><img src="{{asset('assets/admin/images/logo-sm.png')}}" alt="" height="35" /></span>
                  <span class="logo-lg"><img src="{{asset('assets/admin/images/logo-dark.png')}}" alt="" height="30" /></span>
                </a>

                <a href="index.html" class="logo logo-light">
    
                  <span class="logo-sm"><img src="{{asset('assets/admin/images/logo-sm.png')}}" alt="" height="35" /></span>
                  <span class="logo-lg"><img src="{{asset('assets/admin/images/logo-light.png')}}" alt="" height="30" /></span>
                </a>
              </div>
      ...
      <div class="app-menu navbar-menu">
        ...
        <div class="navbar-brand-box">
          ...
          <a href="index.html" class="logo logo-dark">
            <span class="logo-sm">
              <img src="{{asset('assets/admin/images/logo-sm.png')}}" alt="" height="35" />
            </span>
            <span class="logo-lg">
          ...
          <a href="index.html" class="logo logo-light">
            ...
            <span class="logo-lg">
              <img src="{{asset('assets/admin/images/logo-light.png')}}" alt="" height="30" />
            </span>
          </a>
        ...
        <div id="scrollbar">
          <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
              <li class="menu-title"><span data-key="t-menu">القائمة الرئيسية</span></li>
              <li class="nav-item">
                <a class="nav-link menu-link" href="#sidebarDashboards" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards"> <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">القائمة الاولي  </span> </a>
                <div class="collapse menu-dropdown" id="sidebarDashboards">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
                      <a href="{{route('admin.category.index')}}" class="nav-link" data-key="t-analytics">التصنيفات</a>
                    </li>
                    <li class="nav-item">
                      <a href="{{route('admin.subcategory.index')}}" class="nav-link" data-key="t-crm"> التصنيفات الفرعية</a>
                    </li>
                    <li class="nav-item">
                      <a href="{{route('admin.advertisements.index')}}" class="nav-link" data-key="t-ecommerce"> إدارة الاعلانات</a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps"> <i class="ri-apps-2-line"></i> <span data-key="t-apps">القائمة الثانية</span> </a>
                <div class="collapse menu-dropdown" id="sidebarApps">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
                      <a href="{{route('admin.users.index')}}" class="nav-link" data-key="t-analytics">إدراة المستخدمون</a>
                    </li>
                    <li class="nav-item">
                      <a href="{{route('admin.subcategory.index')}}" class="nav-link" data-key="t-crm"> التصنيفات الفرعية</a>
                    </li>
      ...
      <div class="main-content">
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                <script>document.write(new Date().getFullYear());</script>© مخزنكم
              </div>
              <div class="col-sm-6">
                <div class="text-sm-end d-none d-sm-block">كافة الحقوق محفوظه, مخزنكم (ذات مسئوليه محدودة)</div>
              </div>
            </div>
          </div>
        </footer>
...
<button onclick="topFunction()" class="btn btn-danger btn-icon" id="back-to-top">
  ...
  <script>
    ...
    $(document).on('click', '.delete-category', function() {
        ...
        let row = $(this).closest('tr');  // Select the current row
        ...
        if (confirm('Are you sure you want to delete this item?')) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    sweetAlert("Category Deleted successfully.");
                },
                error: function(response) {
                    alert('Error: ' + response.responseText);  // Show error message
                }
            });
        }
    });
        ...
        if (confirm('Are you sure you want to delete this item?')) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    sweetAlert("Subcategory Deleted successfully.");
                },
                error: function(response) {
                    alert('Error: ' + response.responseText);  // Show error message
                }
        ...
        if (confirm('Are you sure you want to delete this item?')) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    sweetAlert("Advertisement Deleted successfully.");
                },
                error: function(response) {
                    alert('Error: ' + response.responseText);  // Show error message
                }
...
function showNotification(type, message) {
    // Here, you might create a notification logic. For this example, we'll just use `alert`.
    alert(message);
}
    ...
    $(document).on('click', '.delete-user', function() {
        ...
        if (confirm('Are you sure you want to delete this item?')) {
            $.ajax({
                ...
                error: function(response) {
                    // Call your function on error too
                    showNotification('error', 'Error: ' + response.responseText);
                }
            });
        }
    });
    ...
    $(document).on('change', '.status-toggle', function() {
        ...
        $.ajax({
            ...
            error: function(response) {
              ...
              sweetAlert("There was an error updating the status.");
...
$(document).on('change', '.status-subcategory', function() {
    let id = $(this).data('id');
    let route = $(this).data('route');
    let status = $(this).prop('checked') ? 1 : 0;
  ...
  function toggleImageState(element) {
      const imageBox = element.parentElement.parentElement;
      const overlay = element.parentElement.previousElementSibling;
      if (element.checked) {
          imageBox.classList.add('dimmed');
          overlay.style.display = 'flex';
      } else {
          imageBox.classList.remove('dimmed');
